...
- 1.2.0 *[July 15, 2019]*
    - Changed `/api/Ürüns` endpoint to allow pagination (see [#1](https://github.com/evgomes/supermarket-api/issues/1)).
...
- 1.1.0 *[June 18, 2019]*
  ...
  - Changed Ürüns listing to allow filtering by category ID, to show how to perform specific queries with EF Core;
